...
//@property(nonatomic) RestoreStateHandler* restoreStateHandler;
@end
//
...
//@end
//
//@interface RestoreStateHandler ()
//@property(nonatomic) FlutterEventSink restoreStateSink;
//@end
...
//                                                          binaryMessenger: [registrar messenger]];
//    FlutterEventChannel* restoreStateChannel = [FlutterEventChannel
//                                                eventChannelWithName:FBLFlutterBleLibRestoreState
//                                                binaryMessenger:[registrar messenger]];
...
//    instance.restoreStateHandler = [[RestoreStateHandler alloc] init];
//
...
//    [restoreStateChannel setStreamHandler:instance.restoreStateHandler];
}
...
//}
//
//- (void) handleResoreState : (NSDictionary*) bleDataMonitorCharacteristicMessage;
//- (void) handleMonitorCharacteristic : (BleDataMonitorCharacteristicMessage*) bleDataMonitorCharacteristicMessage {
//    if (self.monitorCharacteristicHandlerSink != nil) {
//        self.monitorCharacteristicHandlerSink([FlutterStandardTypedData typedDataWithBytes:[bleDataMonitorCharacteristicMessage data]]);
//    }
...
//@end
//
//@interface RestoreStateHandler : NSObject<FlutterStreamHandler>
//- (FlutterError*)onListenWithArguments:(id)arguments eventSink:(FlutterEventSink)eventSink {
//    self.restoreStateSink = eventSink;
//    return nil;
//}
//
//- (FlutterError*)onCancelWithArguments:(id)arguments {
//    self.restoreStateSink = nil;
//    return nil;
//}
//
//- (void) handleResoreState : (NSDictionary*) restoredState;
//    if (self.restoreStateSink != nil) {
//        self.restoreStateSink(restoredState);
//    }
//}
@end
